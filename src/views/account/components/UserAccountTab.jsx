      ...
      <div className="user-profile-block">
        ...
        <div className="user-profile-details">
          ...
          {profile.address ? (
            ...
            <h5 className="text-subtle text-italic">Endereço não cadastrado</h5>
          )}
          <span>Contato</span>
          <br />
          {profile.mobile ? (
            ...
            <h5 className="text-subtle text-italic">Contato não cadastrado</h5>
          )}
          ...
          {profile.dateJoined ? (
            ...
            <h5 className="text-subtle text-italic">Não disponível</h5>
          )}
        </div>
      </div>
    </div>
